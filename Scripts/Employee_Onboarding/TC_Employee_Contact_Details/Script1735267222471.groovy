...
WebUI.click(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/a_PIM'))
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input'), Fullname)
...
WebUI.click(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/button_Search'))
...
WebUI.click(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/div_Actions_oxd-table-cell oxd-padding-cell'))
...
WebUI.click(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/a_Contact Details'))
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input_Street 1_oxd-input oxd-input--focus'),
	Street1)
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input_Street 2_oxd-input oxd-input--active'),
	Street2)
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input_City_oxd-input oxd-input--active'),
	City)
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input_StateProvince_oxd-input oxd-input--active'),
	State)
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input_ZipPostal Code_oxd-input oxd-input--active'),
	ZipCode)
...
WebUI.click(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/i_-- Select --_oxd-icon bi-caret-up-fill ox_627fec'))
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input_Home_oxd-input oxd-input--focus'),
	Tel_Home)
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input_Mobile_oxd-input oxd-input--focus'),
	Tell_Mobile)
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input_Work_oxd-input oxd-input--focus'),
	Tel_Work)
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input_Work Email_oxd-input oxd-input--active'),
	Email_Work)
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/input_Other Email_oxd-input oxd-input--focu_8ec2d9'),
	Email_Other)
...
WebUI.click(findTestObject('Object Repository/Employee-Onboarding/Employee_Contact_Details/Page_OrangeHRM/button_Save'))
